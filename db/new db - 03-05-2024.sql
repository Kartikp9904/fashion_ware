...
CREATE TABLE `orders_info` (
  ...
  `cardname` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `cardnumber` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `expdate` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
INSERT INTO `orders_info` (`order_id`, `userid`, `fullname`, `email`, `address`, `city`, `district`, `state`, `zipcode`, `paymentmethod`, `cardname`, `cardnumber`, `expdate`, `prod_count`, `total_amt`, `cvv`) VALUES
(1, 1, 'rgx', '', 'fgb', 'Ahmedabad', 'Ahmedabad', 'Gujarat', 789456, 'card', 'fbtf', '1111-1234-1234-1234', '12/45', 2, 3800, 147);
